...
public class GenericObject1
{
  ...
  public final String service =
    System.getProperty("skrapi.serviceurl",
		       "https://skr.nlm.nih.gov/cgi-bin/SKR/Restricted_CAS/API_batchValidationII.pl");
  ...
  public final String serviceMMInter =
    System.getProperty("skrapi.servicemminterurl",
		       "https://skr.nlm.nih.gov/cgi-bin/SKR/Restricted_CAS/API_MM_interactive.pl");
  ...
  public final String serviceSRInter =
    System.getProperty("skrapi.servicesrinterurl",
		       "https://skr.nlm.nih.gov/cgi-bin/SKR/Restricted_CAS/API_SR_interactive.pl");
  ...
  public GenericObject1(String username, String password) {
    this.privService = service;
    this.promptCredentials();
   ...
   */
  public GenericObject1(int whichInteractive)
  {
  ...
  public GenericObject1(int whichInteractive, String username, String password) {
    if(whichInteractive == 200)
      this.privService = serviceSRInter;
    else
      this.privService = serviceMMInter;
